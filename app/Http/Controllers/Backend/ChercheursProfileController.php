...
class ChercheursProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('chercheur.pages.profile.index', compact('diplome','pays','parametre'));
...
/**/
       ...
       // $diplome = FormationEmp::all();
        ...
        $parametre = Parametres::first();
        return view('backend.pages.emploipostuler.voircv', compact('user','diplome','parametre','Exp','Compe'));
...
$cher = Chercheur::whereRaw('titre_post_emploi like ? and id_region_post_emploi = ? and id_ville_post_emploi = ?',["%{$Emp->titre_post_emploi}%",$Emp->id_region_post_emploi,$Emp->id_ville_post_emploi])->paginate(2);
//)->where('experience_pros.user_id',$id)->get();
