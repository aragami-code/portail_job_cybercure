...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Backend.pages.dashboard.index',compact('total_admins','total_roles','total_permissions','total_users','total_articles','total_emplois','parametre'));
    ...
    public function indexL()
    {
        ...
        return view('Backend.pageL.dashboard.index',compact('total_admins','total_roles','total_permissions','total_users','total_articles','total_emplois','parametre'));
