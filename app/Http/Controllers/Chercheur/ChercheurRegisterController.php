...
class ChercheurRegisterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('chercheur.auth.registration',compact('parametre'));
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'email' => 'required|max:100|unique:chercheurs,email',
            'date_naiss' => 'required',
           ...
           // 'password_confirmation' => 'required'
            ...
            'email.unique' => 'Cet \'E-mail est deja utilisé par une autre presonne.',
          ...
          if($request->password){
            ...
            $user->remember_token = Chercheur::where('remember_token',md5($request->password))->first();
