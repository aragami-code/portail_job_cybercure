@extends('site.home.fr.master')
    ...
    @section('meta')
    <meta name="description" content="Foire aux questions de CYBER-CURE sur le recrutement des profils de cybersécurité" />

@endsection

@section('title')<title>FAQ  CYBER-CURE, Le meilleur soin c'est la prévention</title>
</title>
@endsection
