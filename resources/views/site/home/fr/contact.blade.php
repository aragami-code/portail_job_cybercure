...
@section('meta')
<meta name="description" content="Déposez vos candidatures dans nos différentes plateformes sociales et à CYBER-CURE" />

@endsection

@section('title')<title>CONTACTS CYBER-CURE, Contacts de l'entreprise</title>
@endsection


@section('name')

<section id="page-title"   style="background-image:  url({{asset('site/img/slider/rev/main/s21.jpg')}}); background-size: cover; background-repeat: no-repeat;" >
            ...
            <div class="row align-items-stretch col-mb-50 mb-0">
                ...
                <div class="col-lg-6">
                    ...
                    <div>
                        ...
                        @endif
                    <form class="mb-0" action="{{route('Messagek')}}"  method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group d-none">
                                    <input type="hidden" id="template-contactform-botcheck" name="status" value="0" class="sm-form-control" />
                                </div>
