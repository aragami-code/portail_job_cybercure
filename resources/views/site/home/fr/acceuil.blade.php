...
@section('meta')
<meta name="description" content="Recrutement des profils cybersécurités" />
@endsection

@section('title')
<title class="lien">ACCUEIL  CYBER-CURE, Le meilleur soin c'est la prévention</title>
@endsection
                        ...
                        <div class="row posts-md col-mb-30">
                            ...
                            Aucun Article trouvé
                               ...
                               <div class="grid-inner">
                                   ...
                                   <a href="#"><img src="{{asset('backend/images/blog')}}/{{$articles->image_article}}" alt="Image"  style="width: 35%; heigth: 35%;"></a>
                                   </div>
                                   ...
                                   <div class="entry-meta">
                                        <ul>
                                           ...
                                           {{$articles->created_at}} <br>
                                           <br>
                                       </ul>
                                   </div>
                                   <div class="entry-content">
                                       <a href="{{route('actud',Crypt::encrypt($articles->id))}}"><p>lire plus</p></a>
                                   </div>
                               </div>
                           </div>
                           @endforeach
