    ...
    <div class="footer-widgets-wrap">
        ...
        <div class="col-lg-6 bottommargin-sm">
          ...
          <h5 class="mb-0">Clients</h5>
                    ...
                    <div class="col-md-5 col-lg-12" style="font-size:10pt">
                        <div class="widget subscribe-widget clearfix">
                            <h5 style="font-size:18pt"><strong>Nous</strong> contacter</h5>
                            ...
                            <form id="widget-subscribe-form" action="#" method="post" class="mb-0">
                                <div class="input-group mx-auto">
                                    ...
                                    <input type="email" style="font-size:16pt" id="widget-subscribe-form-email" name="widget-subscribe-form-email" class="form-control required email" placeholder=" Email">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary" type="submit" style="font-size:16pt">souscrire</button>
                                    </div>
