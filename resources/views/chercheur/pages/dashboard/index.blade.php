            ...
            <div class="col">
                <div class="job-listing-container">
                    ...
                    <div class="job-filter-wrapper">
                       ...
                       <center><b> Recherche avancée</b> </center> <br>
                        <div class="job-filter-dropdown same-pad category">
                            <b>Categorie</b>
                        <div style="position: relative; overflow-y: scroll; width:180px; height:300px">
                        ...
                        <div data-id="job-type" class="job-filter job-type same-pad">
                            ...
                            <h4 class="option-title">Periode:</h4>
                        ...
                        <div data-id="experience" class="job-filter experience same-pad">
                            ...
                            <div style="position: relative; overflow-y: scroll; width:180px; height:300px"
                             ...
                             <div class="job-filter same-pad">
                                <h4 class="option-title">Salaire en k € par an</h4>
                                <div class="price-range-slider" style="width:180px; height:300px">
                                    <b> <input type = "text" id ="amount_start" name="start_price" value="0"
                                      ...
                                      <input type = "text" id = "amount_end" name="end_price" value="250"
                                        style = "border:0; color:#2f4eb4; font-weight:bold;" readonly="on"></b>

                                  <div id = "slider-3"></div>
                                  <div id="showDiv"><div id="showPrice"></div></div>
                                </div>
                                <button onclick="send()" class="btn btn-primary">Filtrer</button>
