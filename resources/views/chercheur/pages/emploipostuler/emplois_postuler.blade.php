...
@include('chercheur.layouts.partials.messages')
    ...
    @foreach ($Emplois_ostuler as $Emploi_Postuler)
    ...
    <div class="job-list">
        ...
        <div class="body">
            <div class="content">
                <h4>  <a href="{{route('chercheur.postemplois.edit',Crypt::encrypt($Emploi_Postuler->post_emploi_id))}}"> {{$Emploi_Postuler->titre_post_emploi}}</a></h4>
            ...
            <div class="more">
                <div class="buttons">
                    ...
                    <a href="{{route('chercheur.postemplois.edit',Crypt::encrypt($Emploi_Postuler->post_emploi_id))}}" class="button" style="color: dodgerblue"><i class="ti-eye" style="color: dodgerblue"></i>Consulter l'offre</a>
