...
@section('title')
Messages Reçus| Tableau de Bord
@endsection
                                ...
                                <tr>
                                    ...
                                    <td>
                                         ...
                                         @if($Message->status == 0)
                                                ...
                                                <form action="{{route('admin.message.upsel', $Message->id)}}" method="POST">
                                                        @method('PUT')
                                                        @csrf
                                                    <a href="{{ route('admin.message.edit',$Message->id) }}"><button class="btn btn-success text-white">lire</button> </a>
                                                </form>

                                         @else
                                                    <br>
                                                       <a class="btn btn-primary text-white"> <i class="fa fa-envelope-o"><span></span></i></a>
                                        ...
                                        <a class="btn btn-danger text-white" href="{{ route('admin.message.destroy', $Message->id) }}"
                                            ...
                                            <i class="fa fa-trash"><span></span></i>
                                        </a>
