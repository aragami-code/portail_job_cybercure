...
@section('title')
Editer une Offre | tableau de bords
@endsection
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{route('admin.postemplois.index')}}">Toute les Offres</a></li>
                <li><span>Editer l'Offre {{$PostEmplois->titre_post_emploi}}</span></li>
                </ul>
            </div>
        </div>
        ...
        <!-- Dark table end -->
         ...
         <div class="col-12 mt-5">
            <div class="card">
                ...
                <form action="{{route('admin.postemplois.update', $PostEmplois->id)}}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input type="text" class="form-control" id="titre_post_emploi" name="titre_post_emploi"  placeholder="Enter le titre de l'offre" required="on" value="{{$PostEmplois->titre_post_emploi}}">

                        </div>

                        <div class="form-group col-md-6 col-sm-12">
                            <label for="slug">Mot(s) clé(s) (separer les mots avec des virgules ex: JAVA,PHP,C#)</label>
                            <input type="text" class="form-control" id="slug_post_emploi" name="slug_post_emploi"  placeholder="le mot cle" required="on" value="{{$PostEmplois->slug_post_emploi}}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                           ...
                           <select name="sectas_post_emploi" id="sectas_post_emploi" class="form-control" required='on'>
                               <option value ="{{$PostEmplois->sectas_post_emploi}}">{{$PostEmplois->sectas_post_emploi}}</option>
                        ...
                        <div class="form-group col-md-3 col-sm-6">
                            ...
                            <select name="typemp_post_emploi" id="typemp_post_emploi" class="form-control" required='on'>
                                ...
                                <option value ="{{$PostEmplois->typemp_post_emploi}}">{{$PostEmplois->typemp_post_emploi}}</option>
                        ...
                        <div class="form-group col-md-3 col-sm-6">
                            ...
                            <select name="contrat_post_emploi" id="contrat_post_emploi" class="form-control" required='on'>
                                <option value ="{{$PostEmplois->contrat_post_emploi}}">{{$PostEmplois->contrat_post_emploi}}</option>
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            <label for="slug">Description de l'entreprise*</label>
                                ...
                                {{$PostEmplois->description_post_emploi}}
                              </textarea>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3 col-sm-6">
                            ...
                            <input type="number" class="form-control" id="salaire_min_post_emploi" name="salaire_min_post_emploi" required="on" value="{{$PostEmplois->salaire_min_post_emploi}}">

                        </div>

                        <div class="form-group col-md-3 col-sm-6">
                            <label for="name">Salaire maximun brut annuel en K €*</label>
                            <input type="number" class="form-control" id="salaire_max_post_emploi" name="salaire_max_post_emploi" required="on" value="{{$PostEmplois->salaire_max_post_emploi}}">
                        ...
                        <div class="form-group col-md-3 col-sm-6">
                            ...
                            <select name="id_formation_post_emploi" id="id_formation_post_emploi" class="form-control" required='on'>
                                ...
                                <option value ="{{$PostEmplois->id_formation_post_emploi}}">{{$PostEmplois->id_formation_post_emploi}}</option>
                    ...
                    <option value ="{{$PostEmplois->ex_prof_post_emploi}}">{{$PostEmplois->ex_prof_post_emploi}}</option>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select name="id_region_post_emploi" id="id_region_post_emploi" class="form-control" required='on'>
                                <option value ="{{$PostEmplois->id_region_post_emploi}}">{{$PostEmplois->id_region_post_emploi}}</option>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select name="id_ville_post_emploi" id="id_ville_post_emploi" class="form-control" required='on'>
                             <option value ="{{$PostEmplois->id_ville_post_emploi}}">{{$PostEmplois->id_ville_post_emploi}}</option>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <input type="date" name="DL" id="DL" class="form-control" value="{{$PostEmplois->DL}}">
                       ...
                       <center> <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Mettre à jour & Publier</button></center>
                    </form>
                </div>
            </div>
        </div>
    ...
    jQuery('select[name="id_region_post_emploi"]').on('change',function(){
        ...
        if(RegionID){
            ...
            $.ajax({
                ...
                url: "{{ url('admin/postemplois/findRegions')}}"+'/'+RegionID,
