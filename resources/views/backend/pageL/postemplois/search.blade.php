    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Recherche</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{route('admin.dashboard')}}">Tableau de Bord</a></li>
                    <li><a href="{{route('admin.postemplois.matcher')}}">matcher une offre</a></li>
                    <li><span>Résultat des recherches</span></li>
                </ul>
            </div>
        </div>
            ...
            @foreach ($cher as $chert)
              ...
              <div class="row"{{$loop->index+1}}>
                 <div class="col-lg-3 col-md-3">
                     {{----}} <img class="avatar user-thumb" src="{{asset('user/images/Chercheur')}}/{{$chert->photo}}" alt="avatar" style="border-radius: 50%; width: 50px; height: 50px;">


                  </div>
                  <div class="col-lg-9 col-md-9">
                      <h5 class="title"><i class="ti-user"></i><b>Nom :{{$chert->nom_famille}} {{$chert->prenom}}</b></h5>
                      <a href="{{asset('user/images/Cv')}}/{{$chert->resume_cv}}">Voir cv </a>
                ...
                {{--       <a href="{{route('chercheur.postemplois.edit', $Emploi_Postuler->id)}}" class="btn btn-primary"><i class="ti-eye"></i> Consulter</a>
              --}}</div>
              </div>

              @endforeach
          {{--$Emplois_Postuler->links()--}} </div>
